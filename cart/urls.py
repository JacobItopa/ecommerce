...
from .views import ProductList, ProductDetail, CartView, IncreaseQuantityView, DecreaseQuantityView, RemoveFromCartView, CheckOutView, PaymentView, ThankYouView, ProfileView
